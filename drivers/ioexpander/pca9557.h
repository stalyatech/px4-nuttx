 ...
 * CONFIG_PCA9557_INT_NCALLBACKS
 *   Maximum number of supported pin interrupt callbacks.
 */

#ifdef CONFIG_IOEXPANDER_INT_ENABLE
#  ifndef CONFIG_PCA9557_INT_NCALLBACKS
#    define CONFIG_PCA9557_INT_NCALLBACKS 4
#  endif
#endif
...
#define PCA9557_GPIO_NPINS 16 /* All pins can be used as GPIOs */
...
#define PCA9557_REG_OUTPUT 0x02
#define PCA9557_REG_POLINV 0x04
#define PCA9557_REG_CONFIG 0x06
...
struct pca9557_dev_s
{
  ...
  uint8_t sreg[8];                      /* Shadowed registers of the PCA9557 */
#endif
  ...
  struct pca9557_callback_s cb[CONFIG_PCA9557_INT_NCALLBACKS];
#endif
};
